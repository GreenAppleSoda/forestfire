  ...
  return (
    <aside className="flex h-full w-full flex-col border-l border-[#d6d3d1] bg-[#F7F5F1]">
      <div className="shrink-0 border-b border-[#e7e5e4] px-5 py-4">
        <p className="text-[11px] font-medium tracking-[0.16em] text-[#78716c] uppercase">
          Records
        </p>
        <p className="mt-1 font-[family-name:var(--font-display)] text-2xl text-[#1c1917]">
      ...
      {!province ? (
        ...
        <>
          <div className="flex shrink-0 items-start justify-between gap-4 border-b border-[#e7e5e4] px-5 py-4">
            <div>
              <p className="text-[11px] font-medium tracking-[0.16em] text-[#78716c] uppercase">
                지역 상세
              </p>
              <h2 className="mt-1 font-[family-name:var(--font-display)] text-2xl tracking-tight text-[#1c1917]">
                {province.name}
              </h2>
              ...
              {probability != null && (
                <p className="mt-2 text-sm">
                  ...
                  {(!probabilityLabel || probabilityLabel.includes("이력")) && (
              ...
              <p className="mt-1.5 text-sm text-[#57534e]">
                산불 {province.fire_count.toLocaleString()}건 · 등록 산{" "}
            ...
            <button
              type="button"
              onClick={onClose}
              className="rounded-md border border-[#d6d3d1] bg-white px-3 py-1.5 text-sm text-[#44403c] transition hover:bg-[#f5f5f4]"
            >
              닫기
            </button>
          </div>
          ...
          <div className="flex shrink-0 border-b border-[#e7e5e4] px-5">
            {(
              ...
              <button
                ...
                type="button"
                onClick={() => setTab(id)}
                className={`mr-4 border-b-2 py-3 text-sm transition ${
                  tab === id
          ...
          <div className="shrink-0 border-t border-[#e7e5e4] px-5 py-3 text-[11px] leading-relaxed text-[#78716c]">
